...
["examples" directory within the Terraform source code](https://github.com/xanzy/terraform-api/tree/master/examples). Each example (as well as the examples
...
them on GitHub](https://github.com/xanzy/terraform-api/tree/master/examples/aws-two-tier).
